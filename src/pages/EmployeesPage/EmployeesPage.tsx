...
import { EmployeeInfoCreateProps } from "./pages/EmployeeInfo/components/EmployeeInfoCreate/EmployeeInfoCreate.types";
...
export const EmployeesPage = () => {
  ...
  const [mountedDialog, openModal] =
    useModal<EmployeeInfoCreateProps>(EmployeeInfoCreate);
